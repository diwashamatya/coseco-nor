        ...
        <section className="about-hero">
          <motion.div className="about-content" variants={fadeUp}>
            ...
            <motion.p variants={fadeUp}>
              Coseco engineers the invisible systems that keep cities moving.
              From Eindhoven to the world, we build the digital backbone of
              modern mobility.
            </motion.p>
          </motion.div>
          ...
          <div className="who-layout">
            ...
            >
              ...
              <div className="who-description">
                ...
                <p>
                  Our mission is simple: make every journey seamless, secure,
                  and future-proof through intelligent software design.
                </p>
              </div>
            </motion.div>
